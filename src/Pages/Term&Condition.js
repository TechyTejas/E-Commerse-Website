...
function TermCondition() {
  return (
    <div style={{ margin: '4rem 2rem 0' }}>
      <h1> Terms and Conditions</h1>
      <p>
      Please read these terms and conditions carefully before using our website ("Site") and engaging in any transactions. These terms and conditions govern your access to and use of the Site, as well as the purchase and use of any products or services provided by [Your Company Name]. By using our Site, you agree to be bound by these terms and conditions.
      </p>
      ...
      <h1>2. Product Information & Pricing </h1>
      <p>
